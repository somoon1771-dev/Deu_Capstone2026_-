...
본 프로젝트에서 사용한 주요 데이터 출처

1. 건물 데이터
- VWorld GIS건물일반집합정보 / GIS건물공간정보
- https://www.vworld.kr/dtmk/dtmk_ntads_s002.do?svcCde=NA&dsId=5

2. CCTV 데이터
- 공공데이터포털 부산광역시 CCTV 설치 현황정보
- https://www.data.go.kr/data/15120867/openapi.do

3. 수목 데이터
- 공공데이터포털 부산광역시 구군 가로수 현황
- https://www.data.go.kr/data/15040363/openapi.do

4. OpenStreetMap
- 보행 네트워크 및 경로 탐색 기반 데이터로 활용
...
## 현장검증 자료
현장검증 사진 및 시연 영상은 GitHub Releases의 `Final Demo Video` 항목에서 확인할 수 있습니다.
